...
| [mcp-it-ops](https://github.com/bastiaan365/mcp-it-ops) | MCP server exposing homelab + IT-ops tools to Claude (v0.0.1: system health, Grafana alerts; tools added one at a time with tests) |
